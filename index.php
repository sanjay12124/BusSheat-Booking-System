...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO contactus (name,email,route,time,phone,description) VALUES ('{$name}','{$email}','{$route}','{$time}','{$phone}','{$description}')";
...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">SL Travel</a>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <br>
            <center>
            <a href="#contact"><button class="btn btn-primary">Scroll Down <i class="fa fa-arrow-down"></i></button></a>
            </center>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    asfdsgfrgtdgdfgdfgdfgdffdgdgreyh  </p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
                ...
                <form action="index.php" method="post">
                    ...
                    <div>
                    <button type="submit" name="submit" class="primary" style="background-color:red; align:center;">Submit</button>
                    </div>
