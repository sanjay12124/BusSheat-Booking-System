    ...
    <?php
        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(isset($_POST["delete"]))
            {
                ...
                $deleteSql = "DELETE FROM `contactus` WHERE `contactus`.`id` = $id";
        ...
        ?>
        <?php
            $resultSql = "SELECT * FROM `contactus` ORDER BY id";
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">No Requests Found!!</h1>
      ...
      <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Do you really want to delete this request? <strong>This process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
